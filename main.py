from utils import ReplayBuffer, json_encode
...
BUFFER_SIZE = 500000
WARMUP_ACTIONS = 25000  # 25000  # 50000
...
def main():
    ...
    for episode in range(MAX_ITER):
        ...
        if (episode % PLOT_FREQ == 0) and (agent.a_count >= agent.warmup):
            ...
            print('\n* Plot this episode {}'.format(episode))
        ...
        while not(env.done):
            ...
            if agent.a_count >= agent.warmup:
                ...
                loss = agent.one_step_gd(minibatch)
