...
class Game2048():
    ...
    def encode_state(self):
        ...
        enc_state = self.one_hot.fit_transform(self.state.reshape(-1,1)).toarray()
    ...
    def render(self, wait=1, figsize=(4,4), iter_=None):
        ...
        # title
        self.ax.set_title("Episode: {}  Score: {}".format(iter_, int(self.score)), fontsize='18', weight='bold', 
    ...
    def add_new_tile(self):
        """ Adds a new value in an empty tile at random. Mostly 2's, occasionally a 4"""
    ...
    def slide_left(self):
        """ Performs one step of the 2048 game assuming the action is 'left', ie
            slides all values to the left, grouping consecutive tiles with equal values"""
    ...
    def reset(self):
        """ Resets the game (state, score and done values) and adds two random 2's"""
